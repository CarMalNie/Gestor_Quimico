...
- [ ] T2 Email recovery flow (native Django): wire `PasswordResetView`,
...
- [ ] T3 Email backend config: `EMAIL_BACKEND = console` for dev (see email in
...
- [ ] T4 Tests: reset request for existing and unknown email (same response,
